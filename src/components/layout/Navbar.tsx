    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
      ...
      <div className={`max-w-6xl mx-auto px-6 flex items-center justify-between transition-all duration-500 ease-out ${
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <img src={logo} alt="The Unlearning School" width="199" height="70" fetchPriority="high" decoding="async" className={`w-auto transition-all duration-500 ease-out group-hover:scale-105 ${scrolled ? "h-8 md:h-9" : "h-10 md:h-12"}`} />
        </Link>
